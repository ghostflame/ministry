...
// useful data:
// influxdb:	https://docs.influxdata.com/influxdb/v0.8/api/reading_and_writing_data/
// opentsdb:	http://opentsdb.net/docs/build/html/user_guide/writing.html#telnet



TTYPE target_type_defns[TGT_TYPE_MAX] =
{
	{
		.type  = TGT_TYPE_UNKNOWN,
		.name  = "unknown",
		.port  = 0,
		.st_id = -1,
		.stype = NULL
	...
	{
		.type  = TGT_TYPE_GRAPHITE,
		.name  = "graphite",
		.port  = 2003,
		.st_id = TGT_STYPE_GRAPHITE,
		.stype = NULL
	},
	{
		.type  = TGT_TYPE_INFLUXDB,
		.name  = "influxdb",
		.port  = 2003,
		.st_id = TGT_STYPE_GRAPHITE,
		.stype = NULL
	},
	{
		...
		.name  = "coal",
		.port  = 3801,
		.st_id = TGT_STYPE_COAL,
		.stype = NULL
	},
	{
		.type  = TGT_TYPE_OPENTSDB,
		.name  = "opentsdb",
		.port  = 0,
		.st_id = TGT_STYPE_OPENTSDB,
		.stype = NULL
	}
};

TSTYPE target_stype_defns[TGT_STYPE_MAX] =
{
	{
		.stype = TGT_STYPE_GRAPHITE,
		.name  = "graphite",
		.tsfp  = &stats_tsf_sec,
		.wrfp  = &target_write_graphite
	},
	{
		.stype = TGT_STYPE_COAL,
		.name  = "coal",
		.tsfp  = &stats_tsf_nsec,
		.wrfp  = &target_write_graphite
	},
	{
		.stype = TGT_STYPE_OPENTSDB,
		.name  = "opentsdb",
		.tsfp  = &stats_tsf_msec,
		.wrfp  = &target_write_opentsdb
	}
};
